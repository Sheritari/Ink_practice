...
from chars_catalog.views import CharacteristicTypeViewSet, CharacteristicViewSet, WellViewSet, WellCharacteristicViewSet, RegisterView
...
urlpatterns = [
    ...
    path('api/v1/', include('chars_catalog.urls'))
]
